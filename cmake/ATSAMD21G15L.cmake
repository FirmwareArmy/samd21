...
set(COMMON_FLAGS "${COMMON_FLAGS} -D__SAMD21G15L__")
...
set(LINKER_FLAGS "${LINKER_FLAGS} -T $ENV{LIBRARY_PATH}/dfp/samd21c/${CMAKE_CXX_COMPILER_ID}/${CMAKE_CXX_COMPILER_ID}/samd21g15l_flash.ld")
