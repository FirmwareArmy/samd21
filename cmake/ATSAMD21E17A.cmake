...
set(COMMON_FLAGS "${COMMON_FLAGS} -D__SAMD21E17A__")
...
set(LINKER_FLAGS "${LINKER_FLAGS} -T $ENV{LIBRARY_PATH}/dfp/samd21a/${CMAKE_CXX_COMPILER_ID}/${CMAKE_CXX_COMPILER_ID}/samd21e17a_flash.ld")
