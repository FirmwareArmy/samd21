...
set(COMMON_FLAGS "${COMMON_FLAGS} -D__SAMD21J16B__")
...
set(LINKER_FLAGS "${LINKER_FLAGS} -T $ENV{LIBRARY_PATH}/dfp/samd21c/${CMAKE_CXX_COMPILER_ID}/${CMAKE_CXX_COMPILER_ID}/samd21j16b_flash.ld")
