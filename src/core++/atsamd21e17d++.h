...
typedef enum IRQn {
	...
	TCC3_IRQn=29, // Timer/Counter for Control Applications 3
...
inline ::Sercom* const SERCOM_INSTS[]={ SERCOM0, SERCOM1, SERCOM2, SERCOM3, } ;
...
const uint32_t FLASH_SIZE=131072 ;
const uint32_t PAGE_SIZE=64 ;
const uint32_t PAGES=2048 ;
const uint32_t ROW_PAGES=4 ;
const uint32_t PAGES_PR_REGION=128 ;
